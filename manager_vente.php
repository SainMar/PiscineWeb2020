...
<head>
  ...
  <title>ECEbay :: MANAGER VENDEUR: <?php echo  $_SESSION["pseudo_user_actual"]?></title>
  ...
  <!--JS-->
    ...
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.4.1/jquery.min.js"></script>
    <script src="mana_vente.js"></script>
    <script src="mana_vente2.js"></script>
        ...
        <?php }
          ...
          <li class="nav-item">
            ...
            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenu2">
              ...
              <?php }?>
                <an href="deconnexion.php" class="dropdown-item option" type="button" id="achatimme">Déconnexion</a>
            </div>
        </div>
          </li>
        </ul>
  ...
  <div class="container content">
    ...
    <div class="row">
      ...
      <div class="col-lg-3" id="menu_g">
            ...
            <h2 class="my-1">Manager Vente de: <?php echo $_SESSION["pseudo_user_actual"]?></h2>
        
            <h6>Choisis un type d'achat:</h6>
            
            <button type="button" class="btn btn-outline-secondary btn-lg elem_panier param_selected btn-block btnmenu"  id="enchere">Enchère</button>
            <button type="button" class="btn btn-outline-secondary btn-lg elem_panier btn-block btnmenu" id="meilloffre">Meilleure Offres</button>
            
            <button type="button" class="btn btn-outline-secondary btn-lg elem_panier btn-block btnmenu" id="historique">Historique de vente</button>
