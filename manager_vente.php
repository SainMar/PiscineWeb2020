  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-3" id="menu_g">
            ...
            <h1 class="my-4">Manager Vente de: <?php echo $_SESSION["pseudo_user_actual"]?></h1>
        
            <h6>Choisis un type d'achat:</h6>
            
            <button type="button" class="btn btn-secondary btn-lg elem_panier param_selected"  id="enchere">Enchère</button>
            <button type="button" class="btn btn-secondary btn-lg elem_panier" id="meilloffre">Meilleure Offres</button>
            
            <button type="button" class="btn btn-secondary btn-lg elem_panier" id="historique">Historique de vente</button>
